# 간접반응 4 유형: 회전율 계 dR/dt = kin - kout R 의 생성(kin) 또는
# 제거(kout)를 약물이 억제(I) 또는 자극(S)한다.  10장에서 쓴 deSolve 로 푼다.
library(deSolve)
kin <- 9; kout <- 0.15; R0 <- kin/kout            # 기저치 R0 = 60
k <- 0.3; V <- 10                                 # 약물: 1구획 IV, t1/2 2.3 hr
