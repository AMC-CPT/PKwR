...
freeze("ch15-schild",      fig = TRUE, fig.w = 7.0, fig.h = 3.2, digits = 4)
freeze("ch15-oper",        fig = TRUE, fig.w = 7.0, fig.h = 3.2, digits = 4)
