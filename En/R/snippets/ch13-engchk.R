# Cross-check: solve the same dosing history as differential equations and compare
THv <- c(3.96, 33.1, 48.3, 6.99)                  # CL (at CLcr 100), V1, V2, Q
Dv  <- data.frame(TIME = c(0, 12, 24), AMT = c(1000, 1000, 0),
                  RATE = c(1000, 1000, 0), DV = NA)      # 1-h infusion of 1000 mg x 2
De2 <- addStop(Dv)
